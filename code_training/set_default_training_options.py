...
def get_flags(MAIN_DIR):
    # tf.app.flags.DEFINE_integer('hyper_angle', 4, 'hyperparameter (weight) of angle')
    ...
    tf.app.flags.DEFINE_list("data_dir", "../data/coco/val2017",
                            "dataset dir list")


    # tf.app.flags.DEFINE_list("mask_dir", "../data/coco/mask",
    #                         "maskset dir list")


    # tf.app.flags.DEFINE_list("hand_data_dir", "../data/OneHand10K/OneHand10K_Train/Train/source",
    #                         "dataset dir list")
